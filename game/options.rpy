...
python early:
    ...
    config.name = "Ren'Py Hotel"
    config.version = "0.03 Walkabout..."
...
init -1 python hide:
    ...
    theme.crayon(
        ...
        mm_root = Solid(black, xysize=(config.screen_width, config.screen_height)),

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = Solid(grey, xysize=(config.screen_width, config.screen_height)),
